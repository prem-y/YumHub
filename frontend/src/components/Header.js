        ...
        <ul className="d-flex justify-content-between list-unstyled ">
            ...
            <div className="mt-3 fs-5">
                <ul className=" d-flex flex-row list-unstyled ">
                    <li className="">
                    <Link to={`/home/${userId}`} className="text-decoration-none m-3 text-white">Veg</Link>
                    </li>
                    <li>
                    <Link to={`/home/${userId}`} className="text-decoration-none m-3 text-white">Non-Veg</Link>
                    </li>
                    <li>
